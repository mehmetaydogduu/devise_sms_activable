...
All the views are packaged inside the gem. If you'd like to customize the views, invoke the following generator and it will copy all the views to your application:
  ...
  rails generate devise_sms_activable2:views

You can also use the generator to generate scoped views:

  rails generate devise_sms_activable2:views users
...
== Contributing to devise_sms_activable2
...
This is copyleft fork of devise_sms_activable2 written by Stefano Valicchia.
